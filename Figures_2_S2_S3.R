###Script to Analyze and Produce Figure 2 and Supplementary Figures 2 and 3
library(ggplot2)
library(ggrepel)
library(cowplot)
library(grid)
...
FigureS2<-plot_grid(TimelinePlot_WT,TimelinePlot_MMR, labels=c("A","B"))
FigureS2
...
FigureS3<-plot_grid(TimelinePlot_Regulators,TimelinePlot_Regulator_Mut,TimelinePlot_Transporters,TimelinePlot_Transporters_Mut,TimelinePlot_Envelope,TimelinePlot_Envelope_Mut,nrow=3)
